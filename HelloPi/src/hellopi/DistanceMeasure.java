...
//    
//    private final static int TRIG_DURATION_IN_MICROS = 500; // trigger duration of 10 micro s
//    private final static int WAIT_DURATION_IN_MILLIS = 500; // wait 60 milli s
//
...
//            
//    private DistanceMeasure( Pin echoPin, Pin trigPin ) {
...
//        Pin trigPin = RaspiPin.GPIO_06; // PI4J custom numbering (pin 7)
//        DistanceMeasure monitor = new DistanceMeasure( echoPin, trigPin );
//        
//        while( true ) {
//            try {
